...
const tag = require("../../services/post/tag");
...
exports.create = async (req, res, next) => {
  ...
  try {
    ...
    result = await tag.create(params);
...
exports.detail = async (req, res, next) => {
  ...
  try {
    ...
    result = await tag.detail(params);
...
exports.update = async (req, res, next) => {
  ...
  try {
    ...
    result = await tag.update(params);
...
exports.delete = async (req, res, next) => {
  ...
  try {
    ...
    result = await tag.delete(params);
