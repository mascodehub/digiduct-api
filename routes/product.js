...
router.post(
  "/",
  [middleware.checkGrants(constant.GRANTS_ROLE), middleware.checkParams(['name','description'])],
  controllers.product.createData
);
router.put(
  "/",
  [middleware.checkGrants(constant.GRANTS_ROLE), middleware.checkParams(['id','name','description'])],
  controllers.product.updateData
);
router.delete(
  "/",
  [middleware.checkGrants(constant.GRANTS_ROLE), middleware.checkParams(['id'])],
